...
export async function generateIndustryInsightData(industry) {
  try {
    ...
    try {
      ...
      console.error(`Gemini estimate fallback failed for ${industry}:`, estimateError);
      throw new Error(estimateError?.message || "Failed to generate industry insights. Please check your AI configuration.");
    }
  }
}
